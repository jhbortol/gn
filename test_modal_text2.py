...
async def run():
    async with async_playwright() as p:
        ...
        # We need to trigger a limit!
        # The limit logic is inside guest list or budget list. Let's add multiple guests to hit the limit.
        ...
        try:
            ...
            for i in range(15): # The limit is usually 10
                add_btn = page.locator('button:has-text("Adicionar"), button:has-text("Novo Convidado")').first
