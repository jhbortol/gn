...
const routes = [{
  path: ':id',
  loadComponent: () => Promise.all(/*! import() */[__webpack_require__.e(76), __webpack_require__.e(451)]).then(__webpack_require__.bind(__webpack_require__, /*! ./fornecedor-page */ 6451)).then(m => m.FornecedorPageComponent)
}];
