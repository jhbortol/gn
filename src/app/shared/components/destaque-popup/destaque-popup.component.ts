      ...
      <div
        ...
        <div class="relative w-full max-w-sm rounded-2xl overflow-hidden pointer-events-auto shadow-[0_30px_80px_rgba(0,0,0,0.55)]"
          ...
          <button
            (click)="close()"
            aria-label="Fechar"
            class="absolute top-4 right-4 z-20 w-8 h-8 rounded-full flex items-center justify-center transition-colors"
            style="background:rgba(255,255,255,0.08); color:rgba(255,255,255,0.6);"
            onmouseenter="this.style.background='rgba(255,255,255,0.16)';this.style.color='#fff';"
            onmouseleave="this.style.background='rgba(255,255,255,0.08)';this.style.color='rgba(255,255,255,0.6)';">
            ...
            <div class="flex flex-col gap-2.5">
              ...
              <button
                *ngIf="hasWhatsApp(f)"
                ...
                class="w-full flex items-center justify-center gap-2 py-3 rounded-xl text-sm font-bold tracking-wide transition-all"
                style="background:linear-gradient(135deg,#1a7a2e 0%,#25a03c 100%); color:#fff; box-shadow:0 4px 18px rgba(30,160,60,0.35);"
              ...
              <a
                ...
                (click)="close()"
                class="w-full block text-center py-3 rounded-xl text-sm font-bold tracking-wide transition-colors"
                style="border:1px solid rgba(212,160,23,0.55); color:#d4a017;"
                onmouseenter="this.style.background='rgba(212,160,23,0.08)';"
